...
public interface Constant {
    ...
    ErrorData E_dataExist = new ErrorData("10016","data exist");
    ...
    ErrorData E_noSupport =  new ErrorData("10031","no support");
    ErrorData E_tokenError =  new ErrorData("10032","token error");
}
